...
<object width="100%" height="100%">
  <param name="movie" value="images/jasperreports-flash-3.0.0.swf"/>
  <embed src="images/jasperreports-flash-3.0.0.swf" 
    FlashVars="jrpxml=jrpxml?jrprint=${jasperPrintName}"
