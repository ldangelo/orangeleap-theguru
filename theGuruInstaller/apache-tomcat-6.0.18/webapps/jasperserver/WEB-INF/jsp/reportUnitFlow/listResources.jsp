...
<head>
  ...
  <script>
        	function editResource(resName){
				document.forms[0].resourceName.value=resName;
				document.forms[0].editResourceButton.click();
        	}
			function editControl(resName){
				document.forms[0].resourceName.value=resName;
				document.forms[0].editControlButton.click();
        	}        	
  </script>
</head>
...
<table width="100%" border="0" cellpading="0" cellspacing="0">
  ...
  <tr><td nowrap="true"><a class="wizard_menu_current" href="javascript:document.forms[0]._eventId_resources.click();"><spring:message code="jsp.reportWizard.resources"/></a></td></tr>
                               ...
                               <%-- Show suggested controls --%>
								...
								<c:forEach items="${wrapper.suggestedControls}" var="contWrap">
                               		    <tr>
	                                        ...
	                                        <td><strong>${contWrap.supportedControlTypes[contWrap.inputControl.type]} <spring:message code="jsp.listResources.inputControl"/></strong></td>
	                                        <td>
