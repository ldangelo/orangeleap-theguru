            ...
            <table border="0" cellpadding="1" cellspacing="0" align="center">
                ...
                <spring:bind path="dataResource.selectedUri">
                    <tr>
                        <td colspan="2">&nbsp;</td>
                        <td>
                            <select name="${status.expression}" size="1" title="<spring:message code="jsp.chooseSource.fromRepository.title"/>" class="fnormal" onClick="document.forms[0].CONTENT_REPOSITORY.click();">
                ...
                <spring:bind path="dataResource.source">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td><input type="radio" name="${status.expression}" id="LOCAL" value="LOCAL" <c:if test='${status.value=="LOCAL"}'>checked="true"</c:if>></td><!--onClick="document.forms[0]._eventId_Next.click();"-->
