            ...
            <table cellpading="1" cellspacing="0" border="0" align="center">
                ...
                <spring:bind path="dataResource.type">
                	<c:forEach items="${allTypes}" var="type" varStatus="counter">
                	    ...
                	    <tr>
                          <td>&nbsp;</td>
	                      <td><!--onClick="document.forms[0]._eventId_Next.click();"--><input type="radio" id="radio${counter.index}" name="${status.expression}" <c:if test='${status.value==type.key}'>checked="true"</c:if>
