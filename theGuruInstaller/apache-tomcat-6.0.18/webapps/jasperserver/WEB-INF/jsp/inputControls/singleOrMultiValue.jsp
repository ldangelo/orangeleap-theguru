...
<html>
<head>
<meta name="pageHeading" content="<spring:message code="jsp.singleOrMultiValue.pageHeading"/>"/>
<title><spring:message code="jsp.singleOrMultiValue.title"/></title>
<script>
...
<table align="center" cellspacing="1" cellpadding="0" border="0">
	...
	<tr>
	  <td>&nbsp;</td>
	  <td colspan="2"><span class="fsection"><spring:message code="jsp.singleOrMultiValue.title"/></span></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
