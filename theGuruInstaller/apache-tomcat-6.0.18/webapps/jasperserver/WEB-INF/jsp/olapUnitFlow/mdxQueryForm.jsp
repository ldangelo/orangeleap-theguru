...
<html>
<head>
  <title><spring:message code="jsp.mdxQueryForm.title"/></title>
  ...
  <tr>
	...
	<FORM name="fmCRPopNLD" action="" method="post">
		<table align="center" cellspacing="1" cellpadding="0" border="0">
			<tr>
				<td>&nbsp;</td>
				<td><span class="fsection"><spring:message code="jsp.mdxQueryForm.header"/></span></td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
			</tr>
			<spring:bind path="wrapper.olapUnitMdxQuery">
				<tr>
				<td align="right" valign="top">* <spring:message code="jsp.mdxQueryForm.header"/>&nbsp;</td>
				<td align="left"><textarea name="${status.expression}" rows="20" cols="60" class="fnormal"><c:out value='${status.value}'/></textarea></td>
			</tr> 
			...
			<tr>
				...
				<td>
				  ...
				  <%-- TODO <input name="_eventId_Validate" value="Validate" type="submit" class="fnormal">&nbsp; --%>
