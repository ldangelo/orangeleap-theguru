...
<html>
  <head>
    <title>
      <spring:message code="jsp.objPermissionToRole.title"/>
    </title>
    <meta name="pageHeading"
          content='<spring:message code="jsp.objPermissionToRole.title"/>'></meta>
  </head>
        ...
        <tr>
          <td width="100%">
            <table border="0" width="100%" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td align="center">
                  <span class="tabTitleFix currentTab"><spring:message code="jsp.objPermission.byRole"/></span>&nbsp;&nbsp;|<span class="tabTitleFix">&nbsp;&nbsp;
                  <a href="javascript:document.frm.resource.value='${param.resource}';document.getElementById('userPermissions').click();"><spring:message code="jsp.objPermission.byUser"/></a></span>
                </td>
              </tr>
            </table>
          </td>
                  ...
                  <table border="0" width="100%" cellpadding="1" cellspacing="0"  class="formtable">         
                    <tr class="fheader">
                     <td class="tableheadercell nonBoldHeader" width="75%" align="left">
                      <spring:message code="jsp.objPermissionToRole.roleName"/>
                     </td>
                     <td class="tableheadercell nonBoldHeader" width="25%" align="left"><spring:message code="jsp.objPermissionToRole.permissionLevel"/></td>
                    </tr>
                <js:paginator items="${roles}" page="${currentPage}">
                  <c:forEach items="${paginatedItems}" var="role"
                             varStatus="status">
                             
                    <c:set var="permission" value="${permissions[role]}" scope="request"/>
...
%>
                    ...
                    <tr <c:if test="${status.count % 2 == 1}">class="tableoddrow"</c:if>>
                      <td class="paddedcell" align="left">
                        <b><a href="javascript:document.getElementById('roleName').value='${role.roleName}';document.getElementById('viewEditRole').click();"><c:out value="${role.roleName}"></c:out></a></b>
                        <%--input type="submit" name="_eventId_viewEditRole"
                               id="viewEditRole"
                               class="fnormal"
                               value=''
                               onclick="document.frm.roleName.value='${role.roleName}';" style="visibility:hidden;"/>
                        <input type="submit" name="_eventId_setPermission"
                               class="fnormal"
                               value='<spring:message code="jsp.objPermission.button.setPermission"/>'
                               onclick="document.frm.roleName.value='${role.roleName}';" style="visibility:hidden;"/--%>
                      </td>
                      <td class="paddedcell" align="right">
                        <%-- by default set the permission already assigned to the role else blank option --%>
                        <input type="hidden"
                               name="prevpermission_${role.roleName}"
                               id="prevpermission_${role.roleName}" 
                               <c:choose>
                        ...
                        <script type="text/javascript">     
                          listOfObjectNames[objectIndex++] = 'permission_'+'${role.roleName}';
                        </script> 
                               
                        <select name="permission_${role.roleName}"
                                id="permission_${role.roleName}"
...
<td>
                        <input type="submit" class="fnormal" name="_eventId_setPermission"
                               value='${permission}'/>  
                        <input type="submit" class="fnormal" name="_eventId_setPermission"
                               value='${inheritedPermission}'/> 
                        <input type="submit" class="fnormal" name="_eventId_setPermission"
                               value='${removeInheritedPermission}'/>                                   
</td>   */
%>
                    </tr>
                    ...
                    <td>
                     <table border="0" cellpadding="0" cellspacing="0">
                       <tr>
                        ...
                        <div class="italic">* <spring:message code="jsp.objPermission.inheritedPermission"/></div>
                        </td>
                       </tr>
                      </table>                   
                    </td>
      ...
      <input type="submit" class="fnormal" name="_eventId_userPermissions"
             id="userPermissions" style="visibility:hidden;"/>
      <input type="submit" name="_eventId_viewEditRole"
                               id="viewEditRole"
                               class="fnormal"
                               value='<spring:message code="jsp.objPermission.button.viewEdit"/>'
