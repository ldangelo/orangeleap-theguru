...
CREATE DEFINER=`theguru`@`%` FUNCTION `COUNTOFVALUES`(FIELDVALUE TEXT, DELIM VARCHAR(124)) RETURNS int(11)
    DETERMINISTIC
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES' */ $$
CREATE DEFINER=`theguru`@`%` FUNCTION `GETCONSTITUENTDISPLAYNAME`(CONSTITUENTID BIGINT) RETURNS varchar(510) CHARSET latin1
    DETERMINISTIC
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES' */ $$
CREATE DEFINER=`theguru`@`%` FUNCTION `GETCONSTITUENTDISPLAYNAMES`(str TEXT, delim VARCHAR(124)) RETURNS text CHARSET latin1
    DETERMINISTIC
BEGIN DECLARE i INT DEFAULT 0;	-- total number of delimiters
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES' */ $$
CREATE DEFINER=`theguru`@`%` FUNCTION `GETCUSTOMFIELD`(ENTITYID INT, ENTITYTYPE VARCHAR(255), FIELDNAME VARCHAR(255)) RETURNS varchar(255) CHARSET latin1
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES' */ $$
CREATE DEFINER=`theguru`@`%` FUNCTION `GETVALUE`(FIELDVALUE TEXT, DELIM VARCHAR(124), VALUEINDEX INT) RETURNS text CHARSET latin1
    DETERMINISTIC
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES' */ $$
CREATE DEFINER=`theguru`@`%` FUNCTION `SPLITCAMELCASEDSTRING`(STRING TEXT) RETURNS text CHARSET latin1
    DETERMINISTIC
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES' */ $$
CREATE DEFINER=`theguru`@`%` PROCEDURE `ASSOCIATECUSTOMFILTERSWITHDATASUBSOURCES`()
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES' */ $$
CREATE DEFINER=`theguru`@`%` PROCEDURE `INSERTREPORTFIELD`(PRIMARYKEYS VARCHAR(255), COLUMNNAME VARCHAR(255), DISPLAYNAME VARCHAR(255), ISDEFAULT BIT, FIELDTYPE INT, FIELDGROUPID LONG)
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES' */ $$
CREATE DEFINER=`theguru`@`%` PROCEDURE `INSERTREPORTFIELDGROUP`(REPORTFIELDGROUPNAME VARCHAR(255), REPORTSUBSOURCE_ID LONG, OUT REPORTFIELDGROUP_ID LONG)
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES' */ $$
CREATE DEFINER=`theguru`@`%` PROCEDURE `INSERTREPORTFIELDWITHALIAS`(PRIMARYKEYS VARCHAR(255), ALIASNAME VARCHAR(255), COLUMNNAME VARCHAR(255), DISPLAYNAME VARCHAR(255), ISDEFAULT BIT, FIELDTYPE INT, FIELDGROUPID LONG)
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES' */ $$
CREATE DEFINER=`theguru`@`%` PROCEDURE `NUMBERBUILDER`()
