...
-- *********************************************************************************************************************
--
-- Code Types & Codes Field Definitions
--
-- *********************************************************************************************************************
...
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''accountManager''))', 'Account Manager Name', b'0', 1, @REPORTFIELDGROUP_ID);

-- Account Manager Account Number
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''accountManager'')', 'Account Manager Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
...
-- Matching
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''organization.matching'')', 'Matching', b'0', 1, @REPORTFIELDGROUP_ID);

-- Percent Matching
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''organization.percentMatch'')', 'Percent Matching', b'0', 3, @REPORTFIELDGROUP_ID);

-- Maximum Match
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''organization.maximumMatch'')', 'Maximum Match', b'0', 5, @REPORTFIELDGROUP_ID);

-- Website
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''organization.website'')', 'Website', b'0', 1, @REPORTFIELDGROUP_ID);

-- Tax ID
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''organization.taxid'')', 'Tax ID', b'0', 1, @REPORTFIELDGROUP_ID);

-- NCAIS Code
CALL INSERTREPORTFIELD('CONSTITUENT_NCAIS_CODE', 'NCAIS Code', b'0', 1, @REPORTFIELDGROUP_ID);

-- Communication Preferences
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''communicationPreferences'')', 'Communication Preferences', b'0', 1, @REPORTFIELDGROUP_ID);

-- Email Format
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''emailFormat'')', 'Email Format', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Birth Date
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''individual.birthDate'')', 'Birth Date', b'0', 4, @REPORTFIELDGROUP_ID);

-- Deceased
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''individual.deceased'')', 'Deceased', b'0', 6, @REPORTFIELDGROUP_ID);

-- Gender
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''individual.gender'')', 'Gender', b'0', 1, @REPORTFIELDGROUP_ID);

-- Race
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''individual.race'')', 'Race', b'0', 1, @REPORTFIELDGROUP_ID);

-- Military
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''individual.military'')', 'Military', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Account Manager Account Number
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''accountManager'')', 'Account Manager Account Number', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Employers' Names
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_EMPLOYERS, '','')', 'Employers'' Names', b'0', 1, @REPORTFIELDGROUP_ID);

-- Employment Title
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''individual.employmentTitle'')', 'Employment Title', b'0', 1, @REPORTFIELDGROUP_ID);

-- Head of Household Account Number
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''individual.headOfHousehold'')', 'Head of Household Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Head of Household Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''individual.headOfHousehold''))', 'Head of Household Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_HOUSEHOLDMEMBERS, '','')', 'Household Members'' Names', b'0', 1, @REPORTFIELDGROUP_ID);

-- Parents' Account Numbers
CALL INSERTREPORTFIELD('CONSTITUENT_PARENTS', 'Parents'' Account Numbers', b'0', 1, @REPORTFIELDGROUP_ID);
-- Parents'' Names
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_PARENTS, '','')', 'Parents'' Names', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Children's Names
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_CHILDREN, '','')', 'Children''s Names', b'0', 1, @REPORTFIELDGROUP_ID);

-- Siblings' Account Numbers
CALL INSERTREPORTFIELD('CONSTITUENT_SIBLINGS', 'Siblings'' Account Numbers', b'0', 1, @REPORTFIELDGROUP_ID);
-- Siblings' Names
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_SIBLINGS, '','')', 'Siblings'' Names', b'0', 1, @REPORTFIELDGROUP_ID);

-- Friends' Account Numbers
CALL INSERTREPORTFIELD('CONSTITUENT_FRIENDS', 'Friends'' Account Numbers', b'0', 1, @REPORTFIELDGROUP_ID);
-- Friends' Names
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_FRIENDS, '','')', 'Friends'' Names', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Employees Names
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_EMPLOYEES, '','')', 'Employees'' Names', b'0', 1, @REPORTFIELDGROUP_ID);

-- Parent Organization
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''organization.parent''))', 'Parent Organization', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_SUBSIDIARYLIST, '','')', 'Subsidiary List Names', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_PRIMARYCONTACTS, '','')', 'Primary Contacts'' Names', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_BILLINGCONTACTS, '','')', 'Billing Contacts'' Names', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_SALESCONTACTS, '','')', 'Sales Contacts'' Names', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_PUBLICRELATIONSCONTACTS, '','')', 'Public Relations Contacts'' Names', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_EMPLOYERS, '','', CONSTITUENT_EMPLOYERS_NUMBERS_NUMBER)', 'Employer''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Employer's Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_EMPLOYERS, '','', CONSTITUENT_EMPLOYERS_NUMBERS_NUMBER))', 'Employer''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_HOUSEHOLDMEMBERS, '','', CONSTITUENT_HOUSEHOLDMEMBERS_NUMBERS_NUMBER)', 'Household Member''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Household Member's Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_HOUSEHOLDMEMBERS, '','', CONSTITUENT_HOUSEHOLDMEMBERS_NUMBERS_NUMBER))', 'Household Member''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_PARENTS, '','', CONSTITUENT_PARENTS_NUMBERS_NUMBER)', 'Parents''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Parent's Member's Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_PARENTS, '','', CONSTITUENT_PARENTS_NUMBERS_NUMBER))', 'Parents''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_CHILDREN, '','', CONSTITUENT_CHILDREN_NUMBERS_NUMBER)', 'Child''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Child's Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_CHILDREN, '','', CONSTITUENT_CHILDREN_NUMBERS_NUMBER))', 'Child''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_SIBLINGS, '','', CONSTITUENT_SIBLINGS_NUMBERS_NUMBER)', 'Sibling''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Sibling's Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_SIBLINGS, '','', CONSTITUENT_SIBLINGS_NUMBERS_NUMBER))', 'Sibling''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Birth Date
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''individual.deceased'')', 'Birth Date', b'0', 6, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_FRIENDS, '','', CONSTITUENT_FRIENDS_NUMBERS_NUMBER)', 'Friend''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Friend's Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_FRIENDS, '','', CONSTITUENT_FRIENDS_NUMBERS_NUMBER))', 'Friend''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_EMPLOYEES, '','', CONSTITUENT_EMPLOYEES_NUMBERS_NUMBER)', 'Employee''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Parent's Member's Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_EMPLOYEES, '','', CONSTITUENT_EMPLOYEES_NUMBERS_NUMBER))', 'Employee''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''organization.parent'')', 'Parent Organization''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Employees' Names
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, ''organization.parent''))', 'Parent Organization''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAMES(CONSTITUENT_SUBSIDIARYLIST, '','')', 'Subsidiary List''s Names', b'0', 1, @REPORTFIELDGROUP_ID);

-- Subsidiary's Account Numbers
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_SUBSIDIARYLIST, '','', CONSTITUENT_SUBSIDIARYLIST_NUMBERS_NUMBER)', 'Subsidiary''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Subsidiary's Names
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_SUBSIDIARYLIST, '','', CONSTITUENT_SUBSIDIARYLIST_NUMBERS_NUMBER))', 'Subsidiary''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_PRIMARYCONTACTS, '','', CONSTITUENT_PRIMARYCONTACTS_NUMBERS_NUMBER)', 'Primary Contact''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Primary Contact's Member's Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_PRIMARYCONTACTS, '','', CONSTITUENT_PRIMARYCONTACTS_NUMBERS_NUMBER))', 'Primary Contact''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_BILLINGCONTACTS, '','', CONSTITUENT_BILLINGCONTACTS_NUMBERS_NUMBER)', 'Billing Contact''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Billing Conatact's Member's Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_BILLINGCONTACTS, '','', CONSTITUENT_BILLINGCONTACTS_NUMBERS_NUMBER))', 'Billing Contact''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_SALESCONTACTS, '','', CONSTITUENT_SALESCONTACTS_NUMBERS_NUMBER)', 'Sales Contact''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Sales Conatact's Member's Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_SALESCONTACTS, '','', CONSTITUENT_SALESCONTACTS_NUMBERS_NUMBER))', 'Sales Contact''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
CALL INSERTREPORTFIELD('GETVALUE(CONSTITUENT_PUBLICRELATIONSCONTACTS, '','', CONSTITUENT_PUBLICRELATIONSCONTACTS_NUMBERS_NUMBER)', 'Public Relations Contact''s Account Number', b'0', 3, @REPORTFIELDGROUP_ID);
-- Public Relations Conatact's Member's Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GETVALUE(CONSTITUENT_PUBLICRELATIONSCONTACTS, '','', CONSTITUENT_PUBLICRELATIONSCONTACTS_NUMBERS_NUMBER))', 'Public Relations Contact''s Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Account Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(GIFT_CONSTITUENT_ID)', 'Account Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Account Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(PAYMENT_HISTORY_CONSTITUENT_ID)', 'Account Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Account Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(PAYMENT_SOURCE_CONSTITUENT_ID)', 'Account Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Account Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(COMMITMENT_CONSTITUENT_ID)', 'Account Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Account Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(ADDRESS_CONSTITUENT_ID)', 'Account Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Account Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(EMAIL_CONSTITUENT_ID)', 'Account Name', b'0', 1, @REPORTFIELDGROUP_ID);
...
-- Account Name
CALL INSERTREPORTFIELD('GETCONSTITUENTDISPLAYNAME(PHONE_CONSTITUENT_ID)', 'Account Name', b'0', 1, @REPORTFIELDGROUP_ID);
