...
Begin
	...
	SET @REPORTDATASUBSOURCE = 'INSERT REPORTDATASUBSOURCE' + @CRLF +
		'  (REPORTSUBSOURCE_ID, DATABASE_TYPE, DISPLAY_NAME, DESCRIPTION, JASPER_DATASOURCE_NAME, REPORT_FORMAT_TYPE, VIEW_NAME, reportDataSubSourceGroup_REPORTSUBSOURCEGROUP_ID)' + @CRLF +
		'VALUES ' + @CRLF + '  (NULL, 1, ''' + @DISPLAYNAME + ''', ''' + @SubSourceDescription + ''', ''/datasources/ReportWizardJdbcDSForMPX'', 1, ''' + @TABLENAME + ''', @REPORTDATASUBSOURCEGROUP_ID);' + @CRLF + @CRLF +
