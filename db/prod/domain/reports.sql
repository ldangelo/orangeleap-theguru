...
insert into REPORTFIELD values(1,b'0',b'0','PERSON_ID','Account Number',b'1',b'0',b'0',b'0',b'0',b'0',3,b'0');
insert into REPORTFIELD values(2,b'0',b'0','FIRST_NAME','First Name',b'1',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(3,b'0',b'0','MIDDLE_NAME','Middle Name',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(4,b'0',b'0','LAST_NAME','Last Name',b'1',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(5,b'0',b'0','ANNIVERSARY','Anniversary Date',b'0',b'0',b'0',b'0',b'0',b'0',4,b'0');
insert into REPORTFIELD values(6,b'0',b'0','BIRTHDATE','Birthday',b'0',b'0',b'0',b'0',b'0',b'0',4,b'0');
insert into REPORTFIELD values(7,b'0',b'0','EMAIL','E-Mail Address',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(8,b'0',b'0','LASED_DONOR','Lapsed Donor',b'0',b'0',b'0',b'0',b'0',b'0',6,b'0');
insert into REPORTFIELD values(9,b'0',b'0','MAJOR_DONOR','Major Donor',b'0',b'0',b'0',b'0',b'0',b'0',6,b'0');
insert into REPORTFIELD values(10,b'0',b'0','MARITAL_STATUS','Marital Status',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(11,b'0',b'0','ORGANIZATION_NAME','Organization',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(12,b'0',b'0','PREFERRED_PHONE_TYPE','Preferred Phone Type',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(13,b'0',b'0','SPOUSE_FIRST_NAME','Spouse First Name',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(14,b'0',b'0','SPOUSE_Name','Spouse Name',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(15,b'0',b'0','SUFFIX','Suffix',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(16,b'0',b'0','TITLE','Title',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(17,b'0',b'0','ADDRESS_LINE_1','Address Line 1',b'1',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(18,b'0',b'0','ADDRESS_LINE_2','Address Line 2',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(19,b'0',b'0','ADDRESS_LINE_3','Address Line 3',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(20,b'0',b'0','ADDRESS_TYPE','Address Type',b'0',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(21,b'0',b'0','CITY','City',b'1',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(22,b'0',b'0','COUNTRY','Country',b'1',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(23,b'0',b'0','POSTAL_CODE','Zip Code',b'1',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(24,b'0',b'0','STATE_PROVINCE','State',b'1',b'0',b'0',b'0',b'0',b'0',1,b'0');
insert into REPORTFIELD values(25,b'0',b'0','TRANSACTION_DATE','Gift Date',b'1',b'0',b'0',b'0',b'0',b'0',4,b'0');
insert into REPORTFIELD values(26,b'0',b'1','VALUE','Gift Amount',b'1',b'0',b'0',b'0',b'0',b'0',5,b'0');
insert into REPORTFIELD values(27,b'0',b'1','AMOUNT','Gift Distribution Amount',b'1',b'0',b'0',b'0',b'0',b'0',5,b'0');
insert into REPORTFIELD values(28,b'0',b'0','MOTIVATION_CODE','Motivation Code',b'1',b'0',b'0',b'0',b'0',b'0',0,b'0');
insert into REPORTFIELD values(29,b'0',b'0','PROJECT_CODE','Project Code',b'1',b'0',b'0',b'0',b'0',b'0',0,b'0');
insert into REPORTFIELD values(30,b'0',b'0','GETPERSONCUSTOMFIELD(PERSON_ID, ''DOGNAME'')','Dog Name',b'0',b'0',b'0',b'0',b'0',b'0',0,b'0');
...
CREATE VIEW VPEOPLEADDRESS AS SELECT `ADDRESS`.`ADDRESS_LINE_1` AS `ADDRESS_LINE_1`,`ADDRESS`.`ADDRESS_LINE_2` AS `ADDRESS_LINE_2`,`ADDRESS`.`ADDRESS_LINE_3` AS `ADDRESS_LINE_3`,`ADDRESS`.`ADDRESS_TYPE` AS `ADDRESS_TYPE`,`ADDRESS`.`CITY` AS `CITY`,`ADDRESS`.`COUNTRY` AS `COUNTRY`,`ADDRESS`.`POSTAL_CODE` AS `POSTAL_CODE`,`ADDRESS`.`STATE_PROVINCE` AS `STATE_PROVINCE`,NULL AS `BIRTHDATE`,`EMAIL`.`EMAIL_ADDRESS` AS `EMAIL`,`PERSON`.`FIRST_NAME` AS `FIRST_NAME`,`PERSON`.`LAPSED_DONOR` AS `LAPSED_DONOR`,`PERSON`.`LAST_NAME` AS `LAST_NAME`,`PERSON`.`MAJOR_DONOR` AS `MAJOR_DONOR`,`PERSON`.`MARITAL_STATUS` AS `MARITAL_STATUS`,`PERSON`.`MIDDLE_NAME` AS `MIDDLE_NAME`,`PERSON`.`ORGANIZATION_NAME` AS `ORGANIZATION_NAME`,`PERSON`.`PREFERRED_PHONE_TYPE` AS `PREFERRED_PHONE_TYPE`,`PERSON`.`SUFFIX` AS `SUFFIX`,`PERSON`.`TITLE` AS `TITLE`,`PERSON`.`PERSON_ID` AS `PERSON_ID`,`ADDRESS`.`ADDRESS_ID` AS `ADDRESS_ID` FROM `PERSON` JOIN `ADDRESS` ON  `ADDRESS`.`PERSON_ID` = `PERSON`.`PERSON_ID` JOIN `EMAIL` ON  `EMAIL`.`PERSON_ID` = `PERSON`.`PERSON_ID`;
-- anniversary, spouse first, spouse name
-- Create vpeoplegift
CREATE VIEW VPEOPLEGIFT AS SELECT `GIFT`.`AUTH_CODE` AS `AUTH_CODE`,`GIFT`.`CHECK_NUMBER` AS `CHECK_NUMBER`,`GIFT`.`COMMENTS` AS `COMMENTS`,`GIFT`.`ORIGINAL_GIFT_ID` AS `ORIGINAL_GIFT_ID`,`GIFT`.`PAYMENT_TYPE` AS `PAYMENT_TYPE`,`GIFT`.`REFUND_GIFT_ID` AS `REFUND_GIFT_ID`,`GIFT`.`REFUND_GIFT_TRANSACTION_DATE` AS `REFUND_GIFT_TRANSACTION_DATE`,`GIFT`.`TRANSACTION_DATE` AS `TRANSACTION_DATE`,`GIFT`.`AMOUNT` AS `VALUE`,`VPEOPLEADDRESS`.`ADDRESS_LINE_1` AS `ADDRESS_LINE_1`,`VPEOPLEADDRESS`.`ADDRESS_LINE_2` AS `ADDRESS_LINE_2`,`VPEOPLEADDRESS`.`ADDRESS_LINE_3` AS `ADDRESS_LINE_3`,`VPEOPLEADDRESS`.`ADDRESS_TYPE` AS `ADDRESS_TYPE`,`VPEOPLEADDRESS`.`CITY` AS `CITY`,`VPEOPLEADDRESS`.`COUNTRY` AS `COUNTRY`,`VPEOPLEADDRESS`.`POSTAL_CODE` AS `POSTAL_CODE`,`VPEOPLEADDRESS`.`STATE_PROVINCE` AS `STATE_PROVINCE`,`VPEOPLEADDRESS`.`BIRTHDATE` AS `BIRTHDATE`,`VPEOPLEADDRESS`.`EMAIL` AS `EMAIL`,`VPEOPLEADDRESS`.`FIRST_NAME` AS `FIRST_NAME`,`VPEOPLEADDRESS`.`LAPSED_DONOR` AS `LAPSED_DONOR`,`VPEOPLEADDRESS`.`LAST_NAME` AS `LAST_NAME`,`VPEOPLEADDRESS`.`MAJOR_DONOR` AS `MAJOR_DONOR`,`VPEOPLEADDRESS`.`MARITAL_STATUS` AS `MARITAL_STATUS`,`VPEOPLEADDRESS`.`MIDDLE_NAME` AS `MIDDLE_NAME`,`VPEOPLEADDRESS`.`ORGANIZATION_NAME` AS `ORGANIZATION_NAME`,`VPEOPLEADDRESS`.`PREFERRED_PHONE_TYPE` AS `PREFERRED_PHONE_TYPE`,`VPEOPLEADDRESS`.`SUFFIX` AS `SUFFIX`,`VPEOPLEADDRESS`.`TITLE` AS `TITLE`,`VPEOPLEADDRESS`.`PERSON_ID` AS `PERSON_ID`,`VPEOPLEADDRESS`.`ADDRESS_ID` AS `ADDRESS_ID` FROM  `GIFT` JOIN `VPEOPLEADDRESS` ON  `GIFT`.`PERSON_ID` = `VPEOPLEADDRESS`.`PERSON_ID`;
-- anniversary, spouse first, spouse name
-- Create vpeoplegiftdistro
CREATE VIEW VPEOPLEGIFTDISTRO AS SELECT  AUTH_CODE, CHECK_NUMBER, COMMENTS, ORIGINAL_GIFT_ID,PAYMENT_TYPE, REFUND_GIFT_ID, REFUND_GIFT_TRANSACTION_DATE, TRANSACTION_DATE, GIFT.AMOUNT AS VALUE, ADDRESS_LINE_1, ADDRESS_LINE_2, ADDRESS_LINE_3, ADDRESS_TYPE, CITY, COUNTRY, POSTAL_CODE, STATE_PROVINCE, BIRTHDATE, EMAIL, FIRST_NAME, LAPSED_DONOR, LAST_NAME, MAJOR_DONOR, MARITAL_STATUS, MIDDLE_NAME, ORGANIZATION_NAME, PREFERRED_PHONE_TYPE, SUFFIX, TITLE, VPEOPLEADDRESS.PERSON_ID, VPEOPLEADDRESS.ADDRESS_ID, DISTRO_LINE.AMOUNT, DISTRO_LINE.PROJECT_CODE FROM GIFT LEFT JOIN DISTRO_LINE ON GIFT.GIFT_ID = DISTRO_LINE.GIFT_ID LEFT JOIN VPEOPLEADDRESS ON GIFT.PERSON_ID = VPEOPLEADDRESS.PERSON_ID;
-- anniversary, spouse first, spouse name, motivation code
-- Create vgiftdistro
CREATE VIEW VGIFTDISTRO AS SELECT AUTH_CODE, CHECK_NUMBER, COMMENTS, ORIGINAL_GIFT_ID,PAYMENT_TYPE, REFUND_GIFT_ID, REFUND_GIFT_TRANSACTION_DATE, TRANSACTION_DATE, GIFT.AMOUNT AS VALUE, DISTRO_LINE.AMOUNT, DISTRO_LINE.PROJECT_CODE FROM GIFT LEFT JOIN DISTRO_LINE ON GIFT.GIFT_ID = DISTRO_LINE.GIFT_ID LEFT JOIN VPEOPLEADDRESS ON GIFT.PERSON_ID = VPEOPLEADDRESS.PERSON_ID;
-- motivation code

-- TEMP remove invalid fields.  Put these back once the views have been update.

DELETE FROM REPORTFIELD_REPORTFIELDGROUP
WHERE REPORTFIELD_ID IN (SELECT REPORTFIELD_ID FROM REPORTFIELD R WHERE COLUMN_NAME LIKE 'ANNIVERSARY')
OR REPORTFIELD_ID IN (SELECT REPORTFIELD_ID FROM REPORTFIELD R WHERE COLUMN_NAME LIKE 'SPOUSE%')
OR REPORTFIELD_ID IN (SELECT REPORTFIELD_ID FROM REPORTFIELD R WHERE COLUMN_NAME LIKE 'MOTIVATION%');


DELETE FROM REPORTFIELD  WHERE COLUMN_NAME LIKE 'ANNIVERSARY';
DELETE FROM REPORTFIELD  WHERE COLUMN_NAME LIKE 'SPOUSE%';
DELETE FROM REPORTFIELD  WHERE COLUMN_NAME LIKE 'MOTIVATION%';
...
INSERT REPORTCUSTOMFILTERDEFINITION_REPORTDATASUBSOURCE VALUES (110000, 1, 1, 12);
INSERT REPORTCUSTOMFILTERDEFINITION_REPORTDATASUBSOURCE VALUES (110000, 2, 2, 13);
INSERT REPORTCUSTOMFILTERDEFINITION_REPORTDATASUBSOURCE VALUES (110000, 3, 3, 14);
INSERT REPORTCUSTOMFILTERDEFINITION_REPORTDATASUBSOURCE VALUES (110000, 4, 4, 15);
INSERT REPORTCUSTOMFILTERDEFINITION_REPORTDATASUBSOURCE VALUES (110000, 5, 5, 16);
