...
CREATE PROCEDURE INSERTCUSTOMFIELDDEFINITION(REPORTFIELDGROUPNAME VARCHAR(255), PRIMARYKEY VARCHAR(255), ALIASNAME VARCHAR(255), PICKLISTNAMEID VARCHAR(255), PICKLISTVIEWFIELDNAME VARCHAR(255), CUSTOMFIELDNAME VARCHAR(255))
BEGIN
	DECLARE CSR_END INT DEFAULT 0;
    ...
    CALL INSERTREPORTFIELDWITHALIAS(PRIMARYKEY, ALIASNAME,
      ...
      CUSTOMFIELDNAME, b'0', 1, REPORTFIELDGROUPID);
  END LOOP;
	SET CSR_END = 0;
...
CREATE PROCEDURE INSERTPROJECTCODECUSTOMFIELDDEFINITION(PICKLISTNAMEID VARCHAR(255), CUSTOMFIELDNAME VARCHAR(255))
BEGIN
  CALL INSERTCUSTOMFIELDDEFINITION('Gift Distribution', 'DISTRO_LINE_DISTRO_LINE_ID', CONCAT('DISTRO_LINE_PROJECT_CODE_', REPLACE(CUSTOMFIELDNAME, ' ', '_')), PICKLISTNAMEID, 'DISTRO_LINE_PROJECT_CODE', CUSTOMFIELDNAME);
  CALL INSERTCUSTOMFIELDDEFINITION('Gift In Kind Details', 'GIFT_IN_KIND_DETAIL_GIK_DETAIL_ID', CONCAT('GIFT_IN_KIND_DETAIL_PROJECT_CODE_', REPLACE(CUSTOMFIELDNAME, ' ', '_')), PICKLISTNAMEID, 'GIFT_IN_KIND_DETAIL_PROJECT_CODE', CUSTOMFIELDNAME);
END$$
