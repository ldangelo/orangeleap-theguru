...
BEGIN
  CALL INSERTCUSTOMFIELDDEFINITION('Gift Distribution', 'DISTRO_LINE_DISTRO_LINE_ID', CONCAT('DISTRO_LINE_PROJECT_CODE_', REPLACE(CUSTOMFIELDNAME, ' ', '_')), PICKLISTNAMEID, 'DISTRO_LINE_PROJECT_CODE', CUSTOMFIELDNAME, CONCAT('Designation ', CUSTOMFIELDNAME));
  CALL INSERTCUSTOMFIELDDEFINITION('Gift In Kind Details', 'GIFT_IN_KIND_DETAIL_GIK_DETAIL_ID', CONCAT('GIFT_IN_KIND_DETAIL_PROJECT_CODE_', REPLACE(CUSTOMFIELDNAME, ' ', '_')), PICKLISTNAMEID, 'GIFT_IN_KIND_DETAIL_PROJECT_CODE', CUSTOMFIELDNAME, CONCAT('Designation ', CUSTOMFIELDNAME));
END$$
