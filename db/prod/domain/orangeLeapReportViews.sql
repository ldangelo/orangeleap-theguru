...
AS
	SELECT
		...
		CASE WHEN CONSTITUENT_TYPE = 'individual' THEN CONSTITUENT_INDIVIDUAL_ROLES WHEN CONSTITUENT_TYPE = 'organization' THEN CONSTITUENT_ORGANIZATION_ROLES ELSE NULL END AS CONSTITUENT_CONSTITUENT_ROLES,
		CASE WHEN CONSTITUENT_TYPE = 'individual' THEN GETVALUE(CONSTITUENT_INDIVIDUAL_ROLES, ',', CONSTITUENT_ROLES_NUMBERS.NUMBER) WHEN CONSTITUENT_TYPE = 'organization' THEN GETVALUE(CONSTITUENT_ORGANIZATION_ROLES, ',', CONSTITUENT_ROLES_NUMBERS.NUMBER) ELSE NULL END CONSTITUENT_CONSTITUENT_ROLE,
		CONSTITUENT_TYPE AS CONSTITUENT_CONSTITUENT_TYPE,
		CREATE_DATE AS CONSTITUENT_CREATE_DATE,
		FIRST_NAME AS CONSTITUENT_FIRST_NAME,
-- 		LAPSED_DONOR AS CONSTITUENT_LAPSED_DONOR,
		LAST_NAME AS CONSTITUENT_LAST_NAME,
		LEGAL_NAME AS CONSTITUENT_LEGAL_NAME,
		LOGIN_ID AS CONSTITUENT_LOGIN_ID,
-- 		MAJOR_DONOR AS CONSTITUENT_MAJOR_DONOR,
		MARITAL_STATUS AS CONSTITUENT_MARITAL_STATUS,
		MIDDLE_NAME AS CONSTITUENT_MIDDLE_NAME,
		NCAIS_CODE AS CONSTITUENT_NCAIS_CODE,
		ORGANIZATION_NAME AS CONSTITUENT_ORGANIZATION_NAME,
		PREFERRED_PHONE_TYPE AS CONSTITUENT_PREFERRED_PHONE_TYPE,
		RECOGNITION_NAME AS CONSTITUENT_RECOGNITION_NAME,
		SUFFIX AS CONSTITUENT_SUFFIX,
		TITLE AS CONSTITUENT_TITLE,
		UPDATE_DATE AS CONSTITUENT_UPDATE_DATE,
		SITE_NAME AS CONSTITUENT_SITE_NAME
	FROM CONSTITUENT
...
AS
	SELECT
		CONSTITUENT.CONSTITUENT_ID AS CONSTITUENT_CONSTITUENT_ID,
		CASE WHEN CONSTITUENT.CONSTITUENT_TYPE = 'individual' THEN CONSTITUENT_INDIVIDUAL_ROLES WHEN CONSTITUENT_TYPE = 'organization' THEN CONSTITUENT_ORGANIZATION_ROLES ELSE NULL END AS CONSTITUENT_CONSTITUENT_ROLES,
		CASE WHEN CONSTITUENT.CONSTITUENT_TYPE = 'individual' THEN GETVALUE(CONSTITUENT_INDIVIDUAL_ROLES, ',', CONSTITUENT_ROLES_NUMBERS.NUMBER) WHEN CONSTITUENT_TYPE = 'organization' THEN GETVALUE(CONSTITUENT_ORGANIZATION_ROLES, ',', CONSTITUENT_ROLES_NUMBERS.NUMBER) ELSE NULL END CONSTITUENT_CONSTITUENT_ROLE,
...
-- 		CONSTITUENT.LAPSED_DONOR AS CONSTITUENT_LAPSED_DONOR,
...
-- 		CONSTITUENT.MAJOR_DONOR AS CONSTITUENT_MAJOR_DONOR,
...
-- 		ADDRESS.ADDRESS_TYPE AS ADDRESS_ADDRESS_TYPE,
	...
	LEFT JOIN NUMBERS AS CONSTITUENT_ROLES_NUMBERS
		ON CONSTITUENT_ROLES_NUMBERS.NUMBER <=
		CASE WHEN CONSTITUENT_TYPE = 'individual' THEN COUNTOFVALUES(CONSTITUENT_INDIVIDUAL_ROLES, ',') WHEN CONSTITUENT_TYPE = 'organization' THEN COUNTOFVALUES(CONSTITUENT_ORGANIZATION_ROLES, ',') ELSE 1 END
	LEFT JOIN ADDRESS ON CONSTITUENT.CONSTITUENT_ID = ADDRESS.CONSTITUENT_ID
;
...
-- 		CONSTITUENT.LAPSED_DONOR AS CONSTITUENT_LAPSED_DONOR,
		...
		CONSTITUENT.LEGAL_NAME AS CONSTITUENT_LEGAL_NAME,
		CONSTITUENT.LOGIN_ID AS CONSTITUENT_LOGIN_ID,
-- 		CONSTITUENT.MAJOR_DONORNOR AS CONSTITUENT_MAJOR_DONOR,
		CONSTITUENT.MARITAL_STATUS AS CONSTITUENT_MARITAL_STATUS,
		CONSTITUENT.MIDDLE_NAME AS CONSTITUENT_MIDDLE_NAME,
		CONSTITUENT.NCAIS_CODE AS CONSTITUENT_NCAIS_CODE,
		CONSTITUENT.ORGANIZATION_NAME AS CONSTITUENT_ORGANIZATION_NAME,
...
-- 		EMAIL.EMAIL_TYPE AS EMAIL_EMAIL_TYPE,
	...
	LEFT JOIN NUMBERS AS CONSTITUENT_ROLES_NUMBERS
		ON CONSTITUENT_ROLES_NUMBERS.NUMBER <=
		CASE WHEN CONSTITUENT_TYPE = 'individual' THEN COUNTOFVALUES(CONSTITUENT_INDIVIDUAL_ROLES, ',') WHEN CONSTITUENT_TYPE = 'organization' THEN COUNTOFVALUES(CONSTITUENT_ORGANIZATION_ROLES, ',') ELSE 1 END
	LEFT JOIN EMAIL ON CONSTITUENT.CONSTITUENT_ID = EMAIL.CONSTITUENT_ID
;
...
-- 		PHONE.PHONE_TYPE AS PHONE_PHONE_TYPE,
	...
	LEFT JOIN NUMBERS AS CONSTITUENT_ROLES_NUMBERS
		ON CONSTITUENT_ROLES_NUMBERS.NUMBER <=
		CASE WHEN CONSTITUENT_TYPE = 'individual' THEN COUNTOFVALUES(CONSTITUENT_INDIVIDUAL_ROLES, ',') WHEN CONSTITUENT_TYPE = 'organization' THEN COUNTOFVALUES(CONSTITUENT_ORGANIZATION_ROLES, ',') ELSE 1 END
	LEFT JOIN PHONE ON CONSTITUENT.CONSTITUENT_ID = PHONE.CONSTITUENT_ID
;
...
-- 		CONSTITUENT_MAJOR_DONOR,
		...
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'individual.organizations') AS CONSTITUENT_EMPLOYERS,
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'headOfHousehold.householdMembers') AS CONSTITUENT_HOUSEHOLDMEMBERS,
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'individual.parents') AS CONSTITUENT_PARENTS,
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'individual.children') AS CONSTITUENT_CHILDREN,
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'individual.siblings') AS CONSTITUENT_SIBLINGS,
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'individual.friends') AS CONSTITUENT_FRIENDS,
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'organization.employees') AS CONSTITUENT_EMPLOYEES,
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'organization.subsidiaryList') AS CONSTITUENT_SUBSIDIARYLIST,
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'organization.primaryContacts') AS CONSTITUENT_PRIMARYCONTACTS,
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'organization.billingContacts') AS CONSTITUENT_BILLINGCONTACTS,
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'organization.salesContacts') AS CONSTITUENT_SALESCONTACTS,
		GETCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'person', 'organization.publicRelationsContacts') AS CONSTITUENT_PUBLICRELATIONSCONTACTS
...
-- 		CONSTITUENT_MAJOR_DONOR,
		...
		CONSTITUENT_UPDATE_DATE,
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_EMPLOYERS,
		CONSTITUENT_EMPLOYERS_NUMBERS.NUMBER AS CONSTITUENT_EMPLOYERS_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_EMPLOYERS_NUMBERS
		ON CONSTITUENT_EMPLOYERS_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_EMPLOYERS, ',')
;


-- *********************************************************************************************************************
--
-- Constituent & Household Members View
--
-- *********************************************************************************************************************
...
-- 		CONSTITUENT_MAJOR_DONOR,,
		...
		CONSTITUENT_UPDATE_DATE,
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_HOUSEHOLDMEMBERS,
		CONSTITUENT_HOUSEHOLDMEMBERS_NUMBERS.NUMBER AS CONSTITUENT_HOUSEHOLDMEMBERS_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_HOUSEHOLDMEMBERS_NUMBERS
		ON CONSTITUENT_HOUSEHOLDMEMBERS_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_HOUSEHOLDMEMBERS, ',')
;


-- *********************************************************************************************************************
--
-- Constituent & Parents View
--
-- *********************************************************************************************************************
...
-- 		CONSTITUENT_MAJOR_DONOR,,
		...
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_PARENTS,
		CONSTITUENT_PARENTS_NUMBERS.NUMBER AS CONSTITUENT_PARENTS_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_PARENTS_NUMBERS
		ON CONSTITUENT_PARENTS_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_PARENTS, ',')
;


-- *********************************************************************************************************************
--
-- Constituent & Children View
--
-- *********************************************************************************************************************
...
-- 		CONSTITUENT_MAJOR_DONOR,,
		...
		CONSTITUENT_UPDATE_DATE,
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_CHILDREN,
		CONSTITUENT_CHILDREN_NUMBERS.NUMBER AS CONSTITUENT_CHILDREN_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_CHILDREN_NUMBERS
		ON CONSTITUENT_CHILDREN_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_CHILDREN, ',')
;


-- *********************************************************************************************************************
--
-- Constituent & Siblings View
--
-- *********************************************************************************************************************
...
-- 		CONSTITUENT_MAJOR_DONOR,,
		...
		CONSTITUENT_UPDATE_DATE,
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_SIBLINGS,
		CONSTITUENT_SIBLINGS_NUMBERS.NUMBER AS CONSTITUENT_SIBLINGS_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_SIBLINGS_NUMBERS
		ON CONSTITUENT_SIBLINGS_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_SIBLINGS, ',')
;


-- *********************************************************************************************************************
--
-- Constituent & Friends View
--
-- *********************************************************************************************************************
...
-- 		CONSTITUENT_MAJOR_DONOR,,
		...
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_FRIENDS,
		CONSTITUENT_FRIENDS_NUMBERS.NUMBER AS CONSTITUENT_FRIENDS_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_FRIENDS_NUMBERS
		ON CONSTITUENT_FRIENDS_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_FRIENDS, ',')
;


-- *********************************************************************************************************************
--
-- Constituent & Employees View
--
-- *********************************************************************************************************************
...
-- 		CONSTITUENT_MAJOR_DONOR,,
		...
		CONSTITUENT_UPDATE_DATE,
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_EMPLOYEES,
		CONSTITUENT_EMPLOYEES_NUMBERS.NUMBER AS CONSTITUENT_EMPLOYEES_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_EMPLOYEES_NUMBERS
		ON CONSTITUENT_EMPLOYEES_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_EMPLOYEES, ',')
;


-- *********************************************************************************************************************
--
-- Constituent & Organizations View  (Parent Organization and Subsidiary List)
--
-- *********************************************************************************************************************
...
-- 		CONSTITUENT_MAJOR_DONOR,
		...
		CONSTITUENT_UPDATE_DATE,
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_SUBSIDIARYLIST,
		CONSTITUENT_SUBSIDIARYLIST_NUMBERS.NUMBER AS CONSTITUENT_SUBSIDIARYLIST_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_SUBSIDIARYLIST_NUMBERS
		ON CONSTITUENT_SUBSIDIARYLIST_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_SUBSIDIARYLIST, ',')
;


-- *********************************************************************************************************************
--
-- Constituent & Primary Contacts View
--
-- *********************************************************************************************************************
...
-- 		CONSTITUENT_MAJOR_DONOR,
		...
		CONSTITUENT_UPDATE_DATE,
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_PRIMARYCONTACTS,
		CONSTITUENT_PRIMARYCONTACTS_NUMBERS.NUMBER AS CONSTITUENT_PRIMARYCONTACTS_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_PRIMARYCONTACTS_NUMBERS
		ON CONSTITUENT_PRIMARYCONTACTS_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_PRIMARYCONTACTS, ',')
;


-- *********************************************************************************************************************
--
-- Constituent & Billing Contacts View
--
-- *********************************************************************************************************************
...
-- 		CONSTITUENT_MAJOR_DONOR,
		...
		CONSTITUENT_UPDATE_DATE,
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_BILLINGCONTACTS,
		CONSTITUENT_BILLINGCONTACTS_NUMBERS.NUMBER AS CONSTITUENT_BILLINGCONTACTS_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_BILLINGCONTACTS_NUMBERS
		ON CONSTITUENT_BILLINGCONTACTS_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_BILLINGCONTACTS, ',')
;


-- *********************************************************************************************************************
--
-- Constituent & Sales Contacts View
--
-- *********************************************************************************************************************
...
-- 		CONSTITUENT_MAJOR_DONOR,
		...
		CONSTITUENT_UPDATE_DATE,
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_SALESCONTACTS,
		CONSTITUENT_SALESCONTACTS_NUMBERS.NUMBER AS CONSTITUENT_SALESCONTACTS_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_SALESCONTACTS_NUMBERS
		ON CONSTITUENT_SALESCONTACTS_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_SALESCONTACTS, ',')
;


-- *********************************************************************************************************************
--
-- Constituent & Public Relations Contacts View
--
-- *********************************************************************************************************************
...
-- 		CONSTITUENT_MAJOR_DONOR,
		...
		CONSTITUENT_UPDATE_DATE,
		CONSTITUENT_SITE_NAME,
		CONSTITUENT_PUBLICRELATIONSCONTACTS,
		CONSTITUENT_PUBLICRELATIONSCONTACTS_NUMBERS.NUMBER AS CONSTITUENT_PUBLICRELATIONSCONTACTS_NUMBERS_NUMBER
	FROM VW_CONSTITUENTS_RELATIONSHIPS
	LEFT JOIN NUMBERS AS CONSTITUENT_PUBLICRELATIONSCONTACTS_NUMBERS
		ON CONSTITUENT_PUBLICRELATIONSCONTACTS_NUMBERS.NUMBER <= COUNTOFVALUES(CONSTITUENT_PUBLICRELATIONSCONTACTS, ',')
;
...
AS
	SELECT
		...
		VW_CONSTITUENTS.CONSTITUENT_CONSTITUENT_ROLES,
...
-- 		VW_CONSTITUENTS.CONSTITUENT_LAPSED_DONOR,
		...
		VW_CONSTITUENTS.CONSTITUENT_LEGAL_NAME,
		VW_CONSTITUENTS.CONSTITUENT_LOGIN_ID,
-- 		VW_CONSTITUENTS.CONSTITUENT_MAJOR_DONOR,
		VW_CONSTITUENTS.CONSTITUENT_MARITAL_STATUS,
		VW_CONSTITUENTS.CONSTITUENT_MIDDLE_NAME,
		VW_CONSTITUENTS.CONSTITUENT_NCAIS_CODE,
		VW_CONSTITUENTS.CONSTITUENT_ORGANIZATION_NAME,
