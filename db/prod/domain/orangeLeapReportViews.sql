...
AS
	...
	LEFT JOIN CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_EMPLOYERS ON CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_EMPLOYERS.CONSTITUENT_ID = VW_CONSTITUENTS.CONSTITUENT_CONSTITUENT_ID AND CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_EMPLOYERS.MASTER_FIELD_DEFINITION_ID = CONCAT('constituent.customFieldMap[', CONSTITUENT_EMPLOYERS.FIELD_NAME, ']')
	...
	LEFT JOIN CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_CHILDREN ON CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_CHILDREN.CONSTITUENT_ID = VW_CONSTITUENTS.CONSTITUENT_CONSTITUENT_ID AND CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_CHILDREN.MASTER_FIELD_DEFINITION_ID = CONCAT('constituent.customFieldMap[', CONSTITUENT_CHILDREN.FIELD_NAME, ']')
	...
	LEFT JOIN CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_SUBSIDIARYLIST ON CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_SUBSIDIARYLIST.CONSTITUENT_ID = VW_CONSTITUENTS.CONSTITUENT_CONSTITUENT_ID AND CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_SUBSIDIARYLIST.MASTER_FIELD_DEFINITION_ID = CONCAT('constituent.customFieldMap[', CONSTITUENT_SUBSIDIARYLIST.FIELD_NAME, ']')
	...
	LEFT JOIN CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_PUBLICRELATIONSCONTACTS ON CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_PUBLICRELATIONSCONTACTS.CONSTITUENT_ID = VW_CONSTITUENTS.CONSTITUENT_CONSTITUENT_ID AND CONSTITUENT_CUSTOM_FIELD_RELATIONSHIP_PUBLICRELATIONSCONTACTS.MASTER_FIELD_DEFINITION_ID = CONCAT('constituent.customFieldMap[', CONSTITUENT_PUBLICRELATIONSCONTACTS.FIELD_NAME, ']')
...
AS
  ...
  LEFT JOIN VW_PLEDGES_DISTRIBUTIONS ON VW_PLEDGES_DISTRIBUTIONS.COMMITMENT_COMMITMENT_ID IN
   (SELECT DISTINCT FIELD_VALUE FROM CUSTOM_FIELD WHERE FIELD_NAME = 'associatedPledgeId' AND ENTITY_TYPE = 'distributionline'
   AND ENTITY_ID IN (SELECT DISTRO_LINE_ID FROM DISTRO_LINE WHERE DISTRO_LINE.GIFT_ID = GIFT.GIFT_ID))
  LEFT JOIN VW_RECURRINGGIFTS_DISTRIBUTIONS ON VW_RECURRINGGIFTS_DISTRIBUTIONS.COMMITMENT_COMMITMENT_ID IN
   (SELECT DISTINCT FIELD_VALUE FROM CUSTOM_FIELD WHERE FIELD_NAME = 'associatedRecurringGiftId' AND ENTITY_TYPE = 'distributionline'
   AND ENTITY_ID IN (SELECT DISTRO_LINE_ID FROM DISTRO_LINE WHERE DISTRO_LINE.GIFT_ID = GIFT.GIFT_ID))
;
...
AS
	SELECT
		...
		PHONE.IS_PRIMARY AS PHONE_IS_PRIMARY
	FROM VW_TOUCHPOINTS
	LEFT JOIN VW_CONSTITUENTS ON VW_TOUCHPOINTS.COMMUNICATION_HISTORY_CONSTITUENT_ID = VW_CONSTITUENTS.CONSTITUENT_CONSTITUENT_ID
	-- Address Information
