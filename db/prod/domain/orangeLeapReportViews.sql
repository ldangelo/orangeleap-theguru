...
AS
	SELECT
		...
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'individual.organizations') AS CONSTITUENT_EMPLOYERS,
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'headOfHousehold.householdMembers') AS CONSTITUENT_HOUSEHOLDMEMBERS,
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'individual.parents') AS CONSTITUENT_PARENTS,
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'individual.children') AS CONSTITUENT_CHILDREN,
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'individual.siblings') AS CONSTITUENT_SIBLINGS,
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'individual.friends') AS CONSTITUENT_FRIENDS,
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'organization.employees') AS CONSTITUENT_EMPLOYEES,
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'organization.subsidiaryList') AS CONSTITUENT_SUBSIDIARYLIST,
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'organization.primaryContacts') AS CONSTITUENT_PRIMARYCONTACTS,
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'organization.billingContacts') AS CONSTITUENT_BILLINGCONTACTS,
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'organization.salesContacts') AS CONSTITUENT_SALESCONTACTS,
		GETCONSTITUENTCUSTOMFIELD(CONSTITUENT_CONSTITUENT_ID, 'organization.publicRelationsContacts') AS CONSTITUENT_PUBLICRELATIONSCONTACTS
