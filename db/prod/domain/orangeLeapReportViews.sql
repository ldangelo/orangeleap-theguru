...
AS
	SELECT
		...
		ADDRESS_TYPE_PICKLISTITEMS.DEFAULT_DISPLAY_VALUE AS ADDRESS_CURRENT_ADDRESS_TYPE,
	...
	FROM CONSTITUENT
	LEFT JOIN ADDRESS ON ADDRESS.ADDRESS_ID = MAILING_ADDRESS(CONSTITUENT.CONSTITUENT_ID)
