...
public class OrangeLeapWebServiceClientV3 extends OrangeLeapAuthentication implements ApplicationContextAware {
	...
	public OrangeLeap getOrangeLeap() {
		...
		try {
			String url = System.getProperty("casClient.serverUrl") +  "/" + siteName + "/services3.0/orangeleap.wsdl";
			String targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/";
