...
<input type="image" src="images/cancel_off.gif" value="Done" name="_cancel" ALT="Done" onmouseover="this.src = 'images/cancel_on.gif';" onmouseout="this.src = 'images/cancel_off.gif';">
</c:if>
</td>
</tr>
</td>
