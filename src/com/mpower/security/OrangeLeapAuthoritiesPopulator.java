...
public class OrangeLeapAuthoritiesPopulator implements LdapAuthoritiesPopulator {
    private static final Log logger = LogFactory.getLog(OrangeLeapAuthoritiesPopulator.class);
     ...
     */
    public OrangeLeapAuthoritiesPopulator(ContextSource contextSource, String groupSearchBase) {
