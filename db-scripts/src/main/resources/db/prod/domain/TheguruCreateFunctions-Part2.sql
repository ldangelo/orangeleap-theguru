...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `GENERATE_FIELD_DEFINITIONS_BUILD_FIELDS`(VIEWNAME VARCHAR(255), TABLENAME VARCHAR(255), TABLECOLUMNPREFIX VARCHAR(255), FIELDGROUPPREFIX VARCHAR(255), FIELDGROUPOVERRIDE VARCHAR(255), PARENTENTITYTYPE VARCHAR(255), SUBFIELDNAME VARCHAR(255), DEFAULTPAGETYPE VARCHAR(255))
BEGIN
	DECLARE CSR_END INT DEFAULT 0;
    ...
    SELECT DISTINCT
		...
		FIELD_LABEL, ENTITY_TYPE, FIELD_NAME, FIELD_TYPE, REFERENCE_TYPE, VALIDATION_FIELD_TYPE
    ...
    SELECT DISTINCT
		FIELD_ORDER, FIELD_DEFINITION_ID, SECONDARY_FIELD_DEFINITION_ID, SECTION_LABEL, SECTION_ORDER,
		FIELD_LABEL, ENTITY_TYPE, SUBSTRING(SECONDARY_FIELD_DEFINITION_ID, LOCATE(CONCAT(SUBFIELDNAME, '.'), SECONDARY_FIELD_DEFINITION_ID) + LENGTH(CONCAT(SUBFIELDNAME, '.')), LENGTH(SECONDARY_FIELD_DEFINITION_ID)), FIELD_TYPE, REFERENCE_TYPE, VALIDATION_FIELD_TYPE
    FROM TEMP_OL_FIELD_DEFINITIONS
	...
	FIELD_DEFINITIONS_LOOP: LOOP
		FETCH CSR_FIELD_DEFINITIONS INTO
			VAR_FIELD_ORDER, VAR_FIELD_DEFINITION_ID, VAR_SECONDARY_FIELD_DEFINITION_ID, VAR_SECTION_LABEL, VAR_SECTION_ORDER,
			VAR_FIELD_LABEL, VAR_ENTITY_TYPE, VAR_FIELD_NAME, VAR_FIELD_TYPE, VAR_REFERENCE_TYPE, VAR_VALIDATION_FIELD_TYPE;
		IF CSR_END THEN
