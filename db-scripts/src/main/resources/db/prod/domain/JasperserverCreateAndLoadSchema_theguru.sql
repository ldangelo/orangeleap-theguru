...
CREATE TABLE `JILogEvent` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK5F32081591865AF` (`userId`),
  CONSTRAINT `FK5F32081591865AF` FOREIGN KEY (`userId`) REFERENCES `JIUser` (`id`)
...
CREATE TABLE `JIObjectPermission` (
  ...
  `recipientobjectclass` varchar(250) DEFAULT NULL,
...
CREATE TABLE `JIReportJob` (
  ...
  KEY `FK156F5F6A4141263C` (`owner`),
  CONSTRAINT `FK156F5F6A4141263C` FOREIGN KEY (`owner`) REFERENCES `JIUser` (`id`),
...
CREATE TABLE `JIReportJobRepoDest` (
  ...
  `output_description` varchar(250) DEFAULT NULL,
...
CREATE TABLE `JIRole` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `rolename` (`rolename`,`tenantId`),
  KEY `FK82724655E415AC2D` (`tenantId`),
  CONSTRAINT `FK82724655E415AC2D` FOREIGN KEY (`tenantId`) REFERENCES `JITenant` (`id`)
...
INSERT INTO `JIRole` (`id`,`rolename`,`externallyDefined`,`tenantId`) VALUES 
 (1,'ROLE_USER',0x00,1),
 (2,'ROLE_ADMINISTRATOR',0x00,1),
 (3,'ROLE_ANONYMOUS',0x00,1),
 (4,'ROLE_USER_COMPANY1',0x00,1),
 (6,'ROLE_ADMIN_COMPANY1',0x00,1),
 (7,'ROLE_USER_DEFAULT',0x00,1),
 (8,'ROLE_ADMIN_DEFAULT',0x00,1),
 (13,'Role_User_Sandbox',0x00,1),
 (14,'Role_User_Demo',0x00,1),
 (15,'Role_Admin_Sandbox',0x00,1),
 (16,'Role_Admin_Demo',0x00,1),
 (17,'Role_User_MPX',0x00,1),
 (18,'Role_Admin_MPX',0x00,1);
/*!40000 ALTER TABLE `JIRole` ENABLE KEYS */;


--
-- Definition of table `JITenant`
--
...
CREATE TABLE `JITenant` (
  ...
  `tenantDesc` varchar(250) DEFAULT NULL,
  `tenantNote` varchar(250) DEFAULT NULL,
  `tenantUri` varchar(250) NOT NULL,
  `tenantFolderUri` varchar(250) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tenantId` (`tenantId`),
  KEY `FKB1D7B2C97803CC2D` (`parentId`),
  CONSTRAINT `FKB1D7B2C97803CC2D` FOREIGN KEY (`parentId`) REFERENCES `JITenant` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `JITenant`
--

/*!40000 ALTER TABLE `JITenant` DISABLE KEYS */;
INSERT INTO `JITenant` (`id`,`tenantId`,`parentId`,`tenantName`,`tenantDesc`,`tenantNote`,`tenantUri`,`tenantFolderUri`) VALUES 
 (1,'organizations',NULL,'root','organizations',' ','/','/');
/*!40000 ALTER TABLE `JITenant` ENABLE KEYS */;
...
CREATE TABLE `JIUser` (
  ...
  `tenantId` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `username` (`username`,`tenantId`),
  KEY `FK8273B1AAE415AC2D` (`tenantId`),
  CONSTRAINT `FK8273B1AAE415AC2D` FOREIGN KEY (`tenantId`) REFERENCES `JITenant` (`id`)
...
INSERT INTO `JIUser` (`id`,`username`,`fullname`,`emailAddress`,`password`,`externallyDefined`,`enabled`,`previousPasswordChangeTime`,`tenantId`) VALUES 
 (1,'anonymousUser','Anonymous User',NULL,'',0x00,0x01,NULL,1),
 (2,'jasperadmin@company1','Jasper Administrator','','',0x00,0x01,'2009-04-22 16:58:53',1),
 (7,'admin@company1','admin','','',0x00,0x01,'2008-12-02 10:53:34',1),
 (8,'admin','Default Administrator','','',0x00,0x01,'2009-01-27 22:30:49',1),
 (9,'demoadmin','demo administrator for two companies','','',0x00,0x01,'2009-04-22 14:02:58',1),
 (12,'user1@company1','user1','','',0x00,0x01,'2009-01-29 14:29:40',1),
 (13,'demouser1','demo user 1','','',0x00,0x01,'2009-04-22 14:03:03',1),
 (15,'demouser1@company1','demo user 1 for company 1','','',0x00,0x01,'2009-01-29 15:36:34',1),
 (16,'demoadmin1','Demo admin for company 1','','',0x00,0x01,'2009-01-29 17:52:10',1),
 (18,'nolan@company1','Nolan Ryan','','',0x00,0x01,'2009-04-22 14:38:01',1),
 (19,'kburstein@demo','Katherine Burstein','katherine.burstein@orangeleap.com','',0x00,0x01,'2009-04-22 14:00:55',1),
 (20,'rnewcomb@company1','Ryan Newcomb','ryan.newcomb@orangeleap.com','',0x00,0x01,'2009-04-22 14:01:51',1),
 (21,'ejohnson@demo','Elyn','ejohnson@orangeleap.com','',0x00,0x01,'2009-04-22 14:02:49',1),
 (22,'ldangelo@demo','Leo D\'Angelo','leo.dangelo@orangeleap.com','',0x00,0x01,'2009-04-22 14:04:25',1),
 (23,'mmccabe@demo','Matt McCabe','matt.mccabe@orangeleap.com','',0x00,0x01,'2009-04-22 14:05:12',1),
 (24,'oleap@demo','Orange Leap','karie.kelly@orangleap.com','',0x00,0x01,'2009-04-22 19:09:31',1),
 (25,'rmccabe@demo','Randy McCabe','randy.mccabe@orangeleap.com','',0x00,0x01,'2009-04-22 14:06:30',1),
 (26,'oleap@sandbox','Orange Leap','karie.kelly@orangleap.com','',0x00,0x01,'2009-04-22 14:07:00',1),
 (27,'kwilliams@mpx','Keri Williams','keri@orangeleap.com','',0x00,0x01,'2009-04-22 14:25:18',1),
 (28,'bklann@demo','Bryan Klann','bryan.klann@orangeleap.com','',0x00,0x01,'2009-04-22 14:08:31',1),
 (29,'dschiwietz@mpx','Dagi Schiwietz','dagi@orangeleap.com','',0x00,0x01,'2009-04-22 14:26:15',1),
 (30,'greg@company1','Greg Maddux','','',0x00,0x01,'2009-04-22 14:26:47',1),
 (31,'jritchie@sandbox','Josiah Ritchie','','',0x00,0x01,'2009-04-22 19:15:43',1),
 (32,'sellingson@sandbox','Sandy Ellingson','','',0x00,0x01,'2009-04-22 19:16:24',1),
 (33,'rnewcomb@demo','Ryan Newcomb','ryan.newcomb@orangeleap.com','',0x00,0x01,'2009-04-23 11:31:12',1),
 (35,'admin1','admin1','','',0x00,0x01,'2009-04-23 13:11:50',1),
 (36,'admin1@sandbox','admin1','','',0x00,0x01,'2009-04-23 13:25:30',1),
 (37,'kkelly@demo','Karie Kelly','karie.kelly@orangeleap.com','',0x00,0x01,'2009-04-23 17:06:07',1),
 (38,'kkelly@sandbox','Kkelly','','',0x00,0x01,'2009-04-23 13:27:14',1),
 (41,'cmarti@sandbox','Chris Marti','cmarti@msci.org','',0x00,0x01,'2009-04-23 16:18:12',1),
 (42,'jmt1@sandbox','Jennifer Charland','jcharland@jmtconsulting.com','',0x00,0x01,'2009-04-27 08:53:17',1),
 (43,'mevans@sandbox','Matt Evans','matt.evans@gwpforum.org','',0x00,0x01,'2009-04-27 10:43:33',1),
 (44,'mbazin@sandbox','Mark Bazin','mbazin@cristoreyhouston.org','',0x00,0x01,'2009-04-27 11:35:54',1),
 (45,'siyer@sandbox','Sabarinath Iyer  ','sabari@teamsure.net','',0x00,0x01,'2009-04-27 13:26:59',1),
 (46,'bsadler@sandbox','Belden Sadler','bsadler@arcstone.com','',0x00,0x01,'2009-04-27 15:09:49',1),
 (47,'rbarnes@sandbox','Rachel Barnes','rbarnes@ftj.com','',0x00,0x01,'2009-04-27 15:40:45',1),
 (48,'desiringgod1@sandbox','Desiring God 1','peter.melling@desiringgod.org','',0x00,0x01,'2009-04-27 15:49:25',1),
 (49,'desiringgod2@sandbox','Desiring God 2','peter.melling@desiringgod.org','',0x00,0x01,'2009-04-27 15:50:11',1),
 (50,'desiringgod3@sandbox','Desiring God 3','peter.melling@desiringgod.org','',0x00,0x01,'2009-04-27 15:50:44',1),
 (51,'desiringgod4@sandbox','Desiring God 4','peter.melling@desiringgod.org','',0x00,0x01,'2009-04-27 15:51:29',1),
 (52,'cscherer@sandbox','Candace Scherer','Execdir@Ovariancancerfoundation.Org','',0x00,0x01,'2009-04-28 08:51:39',1),
 (53,'bdoyle@sandbox','Bernie Doyle','bdymet@christianityworks.com','',0x00,0x01,'2009-04-28 13:24:33',1),
 (54,'renner1@sandbox','Rick Renner Ministries 1','mikeclark@renner.org','',0x00,0x01,'2009-04-28 17:07:28',1),
 (55,'renner2@sandbox','Rick Renner Ministries 2','mikeclark@renner.org','',0x00,0x01,'2009-04-28 17:08:04',1),
 (56,'lweinbrandt@sandbox','Leslie Weinbrandt','leslie.weinbrandt@mosaicinfo.org','',0x00,0x01,'2009-04-30 15:39:11',1),
 (57,'wschiro1@sandbox','WS Chiro 1','dwickes@wschiro.edu','',0x00,0x01,'2009-04-30 16:23:46',1),
 (58,'wschiro2@sandbox','WS Chiro 2','mkimmel@wschiro.edu','',0x00,0x01,'2009-04-30 16:26:02',1),
 (59,'eklotz@sandbox','Elaine Klotz','elaine@ourcenter.org','',0x00,0x01,'2009-05-01 14:18:44',1),
 (60,'mstradinger@sandbox','Mike Stradinger','mstradinger@holland1916.com','',0x00,0x01,'2009-05-01 14:45:49',1),
 (61,'ridley1@sandbox','Ridley College 1','jay_goulart@ridleycollege.com','',0x00,0x01,'2009-05-01 15:05:26',1),
 (62,'ridley2@sandbox','Ridley College 2','jay_goulart@ridleycollege.com','',0x00,0x01,'2009-05-01 15:06:02',1),
 (63,'wdaniels1@sandbox','Walt Daniels User 1','wdhiker@optonline.net','',0x00,0x01,'2009-05-01 15:24:14',1),
 (64,'wdaniels2@sandbox','Walt Daniels User 2','wdhiker@optonline.net','',0x00,0x01,'2009-05-01 15:24:50',1),
 (65,'cpartners1@sandbox','Charity Partners User 1','dme327@aol.com','',0x00,0x01,'2009-05-04 08:44:34',1),
 (66,'cpartners2@sandbox','Charity Partners User 2','dme327@aol.com','',0x00,0x01,'2009-05-04 08:41:50',1),
 (67,'cpartners3@sandbox','Charity Partners User 3','dme327@aol.com','',0x00,0x01,'2009-05-04 08:43:37',1),
 (68,'cpartners4@sandbox','Charity Partners User 4','dme327@aol.com','',0x00,0x01,'2009-05-04 08:44:12',1),
 (69,'jasperadmin','Jasper Administrator','','',0x00,0x01,'2009-04-22 16:58:53',1),
 (70,'lnewsome@sandbox','Liz Newsome','','',0x00,0x01,'2009-05-20 09:25:03',1),
 (71,'jwarren@sandbox','John Warren','','',0x00,0x01,'2009-05-20 09:31:11',1),
 (72,'cbailey@sandbox','Claudia Bailey','','',0x00,0x01,'2009-05-20 09:31:29',1),
 (73,'bwarren@sandbox','Bill Warren','','',0x00,0x01,'2009-05-20 09:31:47',1),
 (74,'jbyron@sandbox','J. Byron','','',0x00,0x01,'2009-05-20 09:51:28',1),
 (75,'jknechtel@sandbox','J Knechtel','','',0x00,0x01,'2009-05-20 09:52:36',1),
 (76,'jparker@sandbox','J Parker','','',0x00,0x01,'2009-05-20 09:53:34',1),
 (77,'jwest@sandbox','J West','','',0x00,0x01,'2009-05-20 09:54:04',1),
 (78,'kspence@sandbox','K Spence','','',0x00,0x01,'2009-05-20 09:54:27',1),
 (79,'lgarome@sandbox','L Garome','','',0x00,0x01,'2009-05-20 09:55:01',1),
 (80,'mdahlman@sandbox','M Dahlman','','',0x00,0x01,'2009-05-20 09:56:22',1),
 (81,'pdxrestore1@sandbox','PDX Restore1','','',0x00,0x01,'2009-05-20 09:57:56',1),
 (82,'pdxrestore2@sandbox','PDX Restore2','','',0x00,0x01,'2009-05-20 09:58:23',1),
 (83,'tfl1@sandbox','TFL1','','',0x00,0x01,'2009-05-20 10:00:40',1),
 (84,'tfl2@sandbox','TFL2','','',0x00,0x01,'2009-05-20 10:01:00',1),
 (85,'aarp1@sandbox','AARP1','','',0x00,0x01,'2009-05-20 10:03:16',1),
 (86,'AARP2@sandbox','AARP2','','',0x00,0x00,'2009-05-20 10:03:36',1),
 (87,'abrown@sandbox','A Brown','','',0x00,0x01,'2009-05-20 10:03:53',1),
 (88,'alucp1@sandbox','ALCUP1','','',0x00,0x01,'2009-05-20 10:05:34',1),
 (89,'alcup2@sandbox','alcup2','','',0x00,0x01,'2009-05-20 10:06:02',1),
 (90,'AUCP1@sandbox','aucp1','','',0x00,0x01,'2009-05-20 10:06:23',1),
 (91,'AUCP2@sandbox','aucp2','','',0x00,0x01,'2009-05-20 10:06:42',1),
 (92,'bautrey@sandbox','Burke Autrey','','',0x00,0x01,'2009-05-20 10:07:08',1),
 (93,'jasperadmin@demo','Jasperadmin Demo','','',0x00,0x01,'2009-05-20 16:50:28',1),
 (94,'jasperadmin@sandbox','Jasperadmin Sandbox','','',0x00,0x01,'2009-05-20 16:52:21',1);
...
--
-- Definition of table `QRTZ_PREVIEW_BLOB_TRIGGERS`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_BLOB_TRIGGERS`;
CREATE TABLE `QRTZ_PREVIEW_BLOB_TRIGGERS` (
  `TRIGGER_NAME` varchar(80) NOT NULL,
  `TRIGGER_GROUP` varchar(80) NOT NULL,
  `BLOB_DATA` blob,
  PRIMARY KEY (`TRIGGER_NAME`,`TRIGGER_GROUP`),
  KEY `TRIGGER_NAME` (`TRIGGER_NAME`,`TRIGGER_GROUP`),
  CONSTRAINT `QRTZ_PREVIEW_BLOB_TRIGGERS_ibfk_1` FOREIGN KEY (`TRIGGER_NAME`, `TRIGGER_GROUP`) REFERENCES `QRTZ_PREVIEW_TRIGGERS` (`TRIGGER_NAME`, `TRIGGER_GROUP`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `QRTZ_PREVIEW_BLOB_TRIGGERS`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_BLOB_TRIGGERS` DISABLE KEYS */;
/*!40000 ALTER TABLE `QRTZ_PREVIEW_BLOB_TRIGGERS` ENABLE KEYS */;


--
-- Definition of table `QRTZ_PREVIEW_CALENDARS`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_CALENDARS`;
CREATE TABLE `QRTZ_PREVIEW_CALENDARS` (
  `CALENDAR_NAME` varchar(80) NOT NULL,
  `CALENDAR` blob NOT NULL,
  PRIMARY KEY (`CALENDAR_NAME`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `QRTZ_PREVIEW_CALENDARS`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_CALENDARS` DISABLE KEYS */;
/*!40000 ALTER TABLE `QRTZ_PREVIEW_CALENDARS` ENABLE KEYS */;


--
-- Definition of table `QRTZ_PREVIEW_CRON_TRIGGERS`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_CRON_TRIGGERS`;
CREATE TABLE `QRTZ_PREVIEW_CRON_TRIGGERS` (
  `TRIGGER_NAME` varchar(80) NOT NULL,
  `TRIGGER_GROUP` varchar(80) NOT NULL,
  `CRON_EXPRESSION` varchar(80) NOT NULL,
  `TIME_ZONE_ID` varchar(80) DEFAULT NULL,
  PRIMARY KEY (`TRIGGER_NAME`,`TRIGGER_GROUP`),
  KEY `TRIGGER_NAME` (`TRIGGER_NAME`,`TRIGGER_GROUP`),
  CONSTRAINT `QRTZ_PREVIEW_CRON_TRIGGERS_ibfk_1` FOREIGN KEY (`TRIGGER_NAME`, `TRIGGER_GROUP`) REFERENCES `QRTZ_PREVIEW_TRIGGERS` (`TRIGGER_NAME`, `TRIGGER_GROUP`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `QRTZ_PREVIEW_CRON_TRIGGERS`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_CRON_TRIGGERS` DISABLE KEYS */;
/*!40000 ALTER TABLE `QRTZ_PREVIEW_CRON_TRIGGERS` ENABLE KEYS */;


--
-- Definition of table `QRTZ_PREVIEW_FIRED_TRIGGERS`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_FIRED_TRIGGERS`;
CREATE TABLE `QRTZ_PREVIEW_FIRED_TRIGGERS` (
  `ENTRY_ID` varchar(95) NOT NULL,
  `TRIGGER_NAME` varchar(80) NOT NULL,
  `TRIGGER_GROUP` varchar(80) NOT NULL,
  `IS_VOLATILE` varchar(1) NOT NULL,
...
--
-- Dumping data for table `QRTZ_PREVIEW_FIRED_TRIGGERS`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_FIRED_TRIGGERS` DISABLE KEYS */;
/*!40000 ALTER TABLE `QRTZ_PREVIEW_FIRED_TRIGGERS` ENABLE KEYS */;


--
-- Definition of table `QRTZ_PREVIEW_JOB_DETAILS`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_JOB_DETAILS`;
CREATE TABLE `QRTZ_PREVIEW_JOB_DETAILS` (
  `JOB_NAME` varchar(80) NOT NULL,
  `JOB_GROUP` varchar(80) NOT NULL,
  `DESCRIPTION` varchar(120) DEFAULT NULL,
  `JOB_CLASS_NAME` varchar(128) NOT NULL,
...
--
-- Dumping data for table `QRTZ_PREVIEW_JOB_DETAILS`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_JOB_DETAILS` DISABLE KEYS */;
/*!40000 ALTER TABLE `QRTZ_PREVIEW_JOB_DETAILS` ENABLE KEYS */;


--
-- Definition of table `QRTZ_PREVIEW_JOB_LISTENERS`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_JOB_LISTENERS`;
CREATE TABLE `QRTZ_PREVIEW_JOB_LISTENERS` (
  `JOB_NAME` varchar(80) NOT NULL,
  `JOB_GROUP` varchar(80) NOT NULL,
  `JOB_LISTENER` varchar(80) NOT NULL,
  PRIMARY KEY (`JOB_NAME`,`JOB_GROUP`,`JOB_LISTENER`),
  KEY `JOB_NAME` (`JOB_NAME`,`JOB_GROUP`),
  CONSTRAINT `QRTZ_PREVIEW_JOB_LISTENERS_ibfk_1` FOREIGN KEY (`JOB_NAME`, `JOB_GROUP`) REFERENCES `QRTZ_PREVIEW_JOB_DETAILS` (`JOB_NAME`, `JOB_GROUP`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `QRTZ_PREVIEW_JOB_LISTENERS`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_JOB_LISTENERS` DISABLE KEYS */;
/*!40000 ALTER TABLE `QRTZ_PREVIEW_JOB_LISTENERS` ENABLE KEYS */;


--
-- Definition of table `QRTZ_PREVIEW_LOCKS`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_LOCKS`;
CREATE TABLE `QRTZ_PREVIEW_LOCKS` (
  `LOCK_NAME` varchar(40) NOT NULL,
  PRIMARY KEY (`LOCK_NAME`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `QRTZ_PREVIEW_LOCKS`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_LOCKS` DISABLE KEYS */;
INSERT INTO `QRTZ_PREVIEW_LOCKS` (`LOCK_NAME`) VALUES 
 ('CALENDAR_ACCESS'),
 ('JOB_ACCESS'),
 ('MISFIRE_ACCESS'),
 ('STATE_ACCESS'),
 ('TRIGGER_ACCESS');
/*!40000 ALTER TABLE `QRTZ_PREVIEW_LOCKS` ENABLE KEYS */;


--
-- Definition of table `QRTZ_PREVIEW_PAUSED_TRIGGER_GRPS`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_PAUSED_TRIGGER_GRPS`;
CREATE TABLE `QRTZ_PREVIEW_PAUSED_TRIGGER_GRPS` (
  `TRIGGER_GROUP` varchar(80) NOT NULL,
  PRIMARY KEY (`TRIGGER_GROUP`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `QRTZ_PREVIEW_PAUSED_TRIGGER_GRPS`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_PAUSED_TRIGGER_GRPS` DISABLE KEYS */;
/*!40000 ALTER TABLE `QRTZ_PREVIEW_PAUSED_TRIGGER_GRPS` ENABLE KEYS */;


--
-- Definition of table `QRTZ_PREVIEW_SCHEDULER_STATE`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_SCHEDULER_STATE`;
CREATE TABLE `QRTZ_PREVIEW_SCHEDULER_STATE` (
  `INSTANCE_NAME` varchar(80) NOT NULL,
...
--
-- Dumping data for table `QRTZ_PREVIEW_SCHEDULER_STATE`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_SCHEDULER_STATE` DISABLE KEYS */;
/*!40000 ALTER TABLE `QRTZ_PREVIEW_SCHEDULER_STATE` ENABLE KEYS */;


--
-- Definition of table `QRTZ_PREVIEW_SIMPLE_TRIGGERS`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_SIMPLE_TRIGGERS`;
CREATE TABLE `QRTZ_PREVIEW_SIMPLE_TRIGGERS` (
  `TRIGGER_NAME` varchar(80) NOT NULL,
  `TRIGGER_GROUP` varchar(80) NOT NULL,
  ...
  PRIMARY KEY (`TRIGGER_NAME`,`TRIGGER_GROUP`),
  KEY `TRIGGER_NAME` (`TRIGGER_NAME`,`TRIGGER_GROUP`),
  CONSTRAINT `QRTZ_PREVIEW_SIMPLE_TRIGGERS_ibfk_1` FOREIGN KEY (`TRIGGER_NAME`, `TRIGGER_GROUP`) REFERENCES `QRTZ_PREVIEW_TRIGGERS` (`TRIGGER_NAME`, `TRIGGER_GROUP`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `QRTZ_PREVIEW_SIMPLE_TRIGGERS`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_SIMPLE_TRIGGERS` DISABLE KEYS */;
/*!40000 ALTER TABLE `QRTZ_PREVIEW_SIMPLE_TRIGGERS` ENABLE KEYS */;


--
-- Definition of table `QRTZ_PREVIEW_TRIGGERS`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_TRIGGERS`;
CREATE TABLE `QRTZ_PREVIEW_TRIGGERS` (
  `TRIGGER_NAME` varchar(80) NOT NULL,
  `TRIGGER_GROUP` varchar(80) NOT NULL,
  `JOB_NAME` varchar(80) NOT NULL,
  `JOB_GROUP` varchar(80) NOT NULL,
  ...
  PRIMARY KEY (`TRIGGER_NAME`,`TRIGGER_GROUP`),
  KEY `JOB_NAME` (`JOB_NAME`,`JOB_GROUP`),
  CONSTRAINT `QRTZ_PREVIEW_TRIGGERS_ibfk_1` FOREIGN KEY (`JOB_NAME`, `JOB_GROUP`) REFERENCES `QRTZ_PREVIEW_JOB_DETAILS` (`JOB_NAME`, `JOB_GROUP`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `QRTZ_PREVIEW_TRIGGERS`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_TRIGGERS` DISABLE KEYS */;
/*!40000 ALTER TABLE `QRTZ_PREVIEW_TRIGGERS` ENABLE KEYS */;


--
-- Definition of table `QRTZ_PREVIEW_TRIGGER_LISTENERS`
--

DROP TABLE IF EXISTS `QRTZ_PREVIEW_TRIGGER_LISTENERS`;
CREATE TABLE `QRTZ_PREVIEW_TRIGGER_LISTENERS` (
  `TRIGGER_NAME` varchar(80) NOT NULL,
  `TRIGGER_GROUP` varchar(80) NOT NULL,
  `TRIGGER_LISTENER` varchar(80) NOT NULL,
  PRIMARY KEY (`TRIGGER_NAME`,`TRIGGER_GROUP`,`TRIGGER_LISTENER`),
  KEY `TRIGGER_NAME` (`TRIGGER_NAME`,`TRIGGER_GROUP`),
  CONSTRAINT `QRTZ_PREVIEW_TRIGGER_LISTENERS_ibfk_1` FOREIGN KEY (`TRIGGER_NAME`, `TRIGGER_GROUP`) REFERENCES `QRTZ_PREVIEW_TRIGGERS` (`TRIGGER_NAME`, `TRIGGER_GROUP`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `QRTZ_PREVIEW_TRIGGER_LISTENERS`
--

/*!40000 ALTER TABLE `QRTZ_PREVIEW_TRIGGER_LISTENERS` DISABLE KEYS */;
/*!40000 ALTER TABLE `QRTZ_PREVIEW_TRIGGER_LISTENERS` ENABLE KEYS */;
