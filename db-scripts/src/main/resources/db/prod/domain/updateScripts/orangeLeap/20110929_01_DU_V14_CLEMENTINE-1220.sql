...
SET JOIN_CRITERIA = 'VW_V2_CONSTITUENTS.CONSTITUENT_CONSTITUENT_ID = VW_V2_GIFTSUMMARIES.CONSTITUENT_ID'
WHERE VIEW_ID IN
(SELECT VIEW_ID FROM THEGURU_VIEW
WHERE VIEW_NAME = 'VW_V2_CONSTITUENTS_GIFTSUMMARIES')
AND JOIN_TABLE = 'VW_V2_GIFTSUMMARIES';

UPDATE THEGURU_VIEW_JOIN
SET JOIN_CRITERIA = 'VW_V2_CONSTITUENTS.CONSTITUENT_CONSTITUENT_ID = VW_V2_GIFTSUMMARIES_EXCLUDINGSOFTGIFTS.CONSTITUENT_ID'
WHERE VIEW_ID IN
(SELECT VIEW_ID FROM THEGURU_VIEW
WHERE VIEW_NAME = 'VW_V2_CONSTITUENTS_GIFTSUMMARIES_EXCLUDINGSOFTGIFTS')
AND JOIN_TABLE = 'VW_V2_GIFTSUMMARIES_EXCLUDINGSOFTGIFTS';
