...
CREATE PROCEDURE INSERTREPORTFIELD(PRIMARYKEYS VARCHAR(255), COLUMNNAME VARCHAR(500), DISPLAYNAME VARCHAR(255), ISDEFAULT BIT, FIELDTYPE INT, FIELDGROUPID BIGINT,
