...
SELECT DISTINCT
  ...
  CONCAT(PRIMARY_TABLE_COLUMN_PREFIX, 'ATTRIBUTE_HISTORY_'), CONCAT(PRIMARY_TABLE_ALIAS, '_AH.ENTITY_TYPE = ''address'' AND ', PRIMARY_TABLE_ALIAS, '_AH.ENTITY_ID = ', PRIMARY_TABLE_ALIAS, '.ADDRESS_ID AND ', PRIMARY_TABLE_ALIAS, '_AH.IS_DELETED = 0'), TRUE, 
...
INSERT THEGURU_VIEW_JOIN
	(VIEW_ID, JOIN_TYPE, JOIN_TABLE, JOIN_TABLE_IS_VIEW, JOIN_TABLE_ALIAS, JOIN_TABLE_COLUMN_PREFIX, JOIN_CRITERIA, INCLUDE_ALL_FIELDS, SORT_ORDER, FIELD_GROUP_PREFIX)
SELECT DISTINCT
	VIEW_ID, 'LEFT', 'ATTRIBUTE_HISTORY', FALSE, CONCAT(JOIN_TABLE_ALIAS, '_AH'), CONCAT(JOIN_TABLE_COLUMN_PREFIX, 'ATTRIBUTE_HISTORY_'),
...
INSERT THEGURU_VIEW_JOIN
	(VIEW_ID, JOIN_TYPE, JOIN_TABLE, JOIN_TABLE_IS_VIEW, JOIN_TABLE_ALIAS, JOIN_TABLE_COLUMN_PREFIX, JOIN_CRITERIA, INCLUDE_ALL_FIELDS, SORT_ORDER, FIELD_GROUP_PREFIX)
SELECT DISTINCT
	VIEW_ID, 'LEFT', 'ATTRIBUTE_HISTORY', FALSE, CONCAT('RGP_ADDRESS', '_AH'), CONCAT('RGP_ADDRESS_', 'ATTRIBUTE_HISTORY_'),
...
INSERT THEGURU_VIEW_JOIN
	(VIEW_ID, JOIN_TYPE, JOIN_TABLE, JOIN_TABLE_IS_VIEW, JOIN_TABLE_ALIAS, JOIN_TABLE_COLUMN_PREFIX, JOIN_CRITERIA, INCLUDE_ALL_FIELDS, SORT_ORDER, FIELD_GROUP_PREFIX)
SELECT DISTINCT
	VIEW_ID, 'LEFT', 'ATTRIBUTE_HISTORY', FALSE, CONCAT('AGP_ADDRESS', '_AH'), CONCAT('AGP_ADDRESS_', 'ATTRIBUTE_HISTORY_'),
...
INSERT THEGURU_VIEW_JOIN
	(VIEW_ID, JOIN_TYPE, JOIN_TABLE, JOIN_TABLE_IS_VIEW, JOIN_TABLE_ALIAS, JOIN_TABLE_COLUMN_PREFIX, JOIN_CRITERIA, INCLUDE_ALL_FIELDS, SORT_ORDER, FIELD_GROUP_PREFIX)
SELECT DISTINCT
	VIEW_ID, 'LEFT', 'ATTRIBUTE_HISTORY', FALSE, CONCAT('RGP_PHONE', '_AH'), CONCAT('RGP_PHONE_', 'ATTRIBUTE_HISTORY_'),
...
INSERT THEGURU_VIEW_JOIN
	(VIEW_ID, JOIN_TYPE, JOIN_TABLE, JOIN_TABLE_IS_VIEW, JOIN_TABLE_ALIAS, JOIN_TABLE_COLUMN_PREFIX, JOIN_CRITERIA, INCLUDE_ALL_FIELDS, SORT_ORDER, FIELD_GROUP_PREFIX)
SELECT DISTINCT
	VIEW_ID, 'LEFT', 'ATTRIBUTE_HISTORY', FALSE, CONCAT('AGP_PHONE', '_AH'), CONCAT('AGP_PHONE_', 'ATTRIBUTE_HISTORY_'),
...
INSERT THEGURU_VIEW_JOIN
	(VIEW_ID, JOIN_TYPE, JOIN_TABLE, JOIN_TABLE_IS_VIEW, JOIN_TABLE_ALIAS, JOIN_TABLE_COLUMN_PREFIX, JOIN_CRITERIA, INCLUDE_ALL_FIELDS, SORT_ORDER, FIELD_GROUP_PREFIX)
SELECT DISTINCT
	VIEW_ID, 'LEFT', 'ATTRIBUTE_HISTORY', FALSE, CONCAT(PRIMARY_TABLE_ALIAS, '_AH'), CONCAT(PRIMARY_TABLE_COLUMN_PREFIX, 'ATTRIBUTE_HISTORY_'),
