...
CALL ADDREPORTFIELDS('ADJUSTED_GIFT_ADJUSTED_GIFT_ID', 'Adjusted Gift Segmentation');
CALL ADDREPORTFIELDS('VW_AGD_ADJUSTED_GIFT_ADJUSTED_GIFT_ID', 'Adjusted Gift Segmentation');
