...
<TABLE id="report_standard_filters" class="tablesorter" style="display: none;" bgcolor=#E0E0E0 >
	...
	<TR index="-1" >
		...
		<TD align=center><input type="checkbox" objectname="reportFilters[INDEXREPLACEMENT].reportStandardFilter.promptForCriteria" <c:if test="${(currentFilter == null) || ((currentFilter != null) && (currentFilter.reportStandardFilter.promptForCriteria == true))}">checked="checked"</c:if> value="true"	onclick="togglePromptForCriteriaTextBox(this);"	></TD>
